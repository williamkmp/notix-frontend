...
async function doUpload() {
    ...
    if (cropperRef.value) {
        ...
        try {
            const imageUploadResponse: ServerData<FileDto> = await privateApi.postForm(
                '/api/file',
                {
                    file: resizedBlob,
                },
            ...
            const userUpdateResponse: ServerData<UserDto> = await privateApi.put(
                '/api/user',
                {
            ...
            app.user = userUpdateResponse.data;
